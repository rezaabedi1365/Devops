...
| بخش                         | توضیحات                                        | پارت‌نامبر                 |
| --------------------------- | ---------------------------------------------- | -------------------------- |
| **سرور / Chassis**          | شاسی پایه RX2540 M7 با کیج داخلی تا 16 Bay     | VFY\:R2547SC010PL          |
| **پردازنده / CPU**          | 2 × Intel Xeon Gold 6430, 32 هسته‌ای           | P49614-B21                 |
| **حافظه / RAM**             | 32 × 64GB DDR5-4800MHz RDIMM ECC (Samsung)     | M321R8GA0BB0-CQK           |
| **هارد دیسک / HDD**         | 8 × 1.2TB 2.5" SAS 10K RPM (HP)                | 872479-B21                 |
| **Tray / Caddy هارد**       | 8 × Tray/Caddy برای نصب هارد ۲.۵ اینچی روی کیج | A3C40179841                |
| **کنترلر RAID**             | Fujitsu / HP RAID Controller                   | PY-SR4C63                  |
| **منبع تغذیه / PSU**        | 2 × 900W Titanium Hot-Plug                     | PY-PU901                   |
| **کیت رک / Rack Mount Kit** | نصب در رک ۱۹ اینچ                              | CA05950‑2169               |
| **کابل‌ها و اتصالات**       | کابل‌های SAS/SATA و برق و شبکه                 | مطابق نیاز سرور و پیکربندی |
