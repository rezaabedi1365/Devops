...
```
### 2- Nodeport service
:heavy_check_mark:  Nodeport service with HAproxy ingress controller and External HAproxy use for project
- [ExternalIP(Master|worker):3000] 5.120.11.20:30008 > [NodportSVC-IP] 10.244.2.8:8080  > [Pod-IP] 10.10.12.20:80
